...
from dse import timestamps
import time
from threading import Thread, Lock

class _TimestampTestMixin(object):

    @mock.patch('dse.timestamps.time')
    def _call_and_check_results(self,
        ...
        pairs, call a :class:`dse.timestamps.MonotonicTimestampGenerator`
...
class TestTimestampGeneratorLogging(unittest.TestCase):
    ...
    def setUp(self):
        self.log_patcher = mock.patch('dse.timestamps.log')
