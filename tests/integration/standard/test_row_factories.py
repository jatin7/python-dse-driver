...
from dse.cluster import Cluster, ResultSet, ExecutionProfile, EXEC_PROFILE_DEFAULT
from dse.query import tuple_factory, named_tuple_factory, dict_factory, ordered_dict_factory
...
class RowFactoryTest(BasicSharedKeyspaceUnitTestCaseWFunctionTable):
    """
